            ...
            <ul class="navbar-nav mr-auto">
              ...
              <?php 
                ...
                <?php
                  if($un_dtl_unidade == 2){
                ?>
                <a class="dropdown-item" href="consultas.php">Consultas Pendentes</a>
                <?php 
                  }else{
                ?>
                <a class="dropdown-item" href="consultas_ubs.php">Consultas Pendentes</a>
                <?php 
                  };
                ?>
                <div class="dropdown-divider"></div>
                <?php
                  if($un_dtl_unidade == 2){
                ?>
                <a class="dropdown-item" href="consultas2.php">Consultas Realizadas</a>
                <?php 
                  }else{
                ?>
                 <a class="dropdown-item" href="consultas2_ubs.php">Consultas Realizadas</a>
                 <?php 
                  };
                ?>
              </div>
