    ...
    <div class="col-lg-12 ">
      <section class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><b>Consultas Realizadas</b></a>
          </li>                  
        </ul>
      </section>
      </br>
            ...
            <div class="row">
              <table class="table table-striped">
                ...
                <?php
                 ...
                 extract($resultado);
                  ...
                  $sth = $pdo->prepare('
                    ...
                    INNER JOIN tbl_paciente p on  p.p_codigo = c.conn_paciente
                ...
                <tbody>
                  <tr>
                    <th scope="row">
                        <h5><center><?= substr($con_codigo, 0, 10); ?></center></h5>
                    </th>
                    <td><h5><?= substr($p_nome, 0, 38); ?></h5></td>
                    <td><h5><?= substr($con_data, 0, 38); ?></h5></td>
                    <?php
                      ...
                      extract($resultado);
                    ?>
                    <td><h5><?= substr($me_nome, 0, 38); ?></h5></td>
                    <td> 
                      ...
                      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body text-left"> Tem certeza que deseja excluir essa consulta ? </div>
                              <div class="modal-footer">
                                <a href="delete_consultas2.php?id=<?= $con_codigo;?>"><button type="button" class="btn btn-primary"><span class="text-white">Sim </span></button></a>
