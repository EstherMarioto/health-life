...
<?php
    ...
    $sth = $pdo->prepare("
    select *from tbl_paciente_ubs where p_nome LIKE '%$paciente%'");
    $sth->execute();
        ...
        <div class="row">
            <div class="card" style="width: 20rem;">
                <div class="card-body" style="background-color: #a7ffeb"> 
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                        <a href="../../paciente/pressao.php?paciente=<?= $p_loginn;?>">
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-3">
                                            <?php 
                                                    ...
                                                    $sth->bindValue(':en_login', $p_loginn);
                                                    $sth->execute();
                                                    $resultado = $sth->fetch(PDO::FETCH_ASSOC);
                                                    extract($resultado);
                                                    };
                            ...
                            <div class="container">
                                <div class="col s2 m12 offset-m1 center" style="background-color:  #a7ffeb">
                                    ...
                                    <?php
                                        ...
                                        $sth->bindValue(':da_paciente', $p_loginn);
                                        $sth->execute();
                                        foreach ($sth as $res) :
                                        extract($res);
                                    ?>
                            ...
                            <div class="modal-dialog modal-lg" role="document">                
                                <div class="modal-content">
                                    ...
                                    <form name="form1" action="update_ver.php" method="post">
                                        <input name="paciente" type="hidden" value="<?=  $p_loginn; ?>">
                                        <input name="dados" type="hidden" value="<?=  $da_codigo; ?>">
                                        <?php  
                                            $sth = $pdo->prepare('select *from tbl_medico where me_login = :me_login ');
                                            $sth->bindValue(':me_login', $_SESSION["health"]["id"]);
