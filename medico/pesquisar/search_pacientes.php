  ...
  <body>
    ...
    <div class="container" >
      <nav aria-label="breadcrumb" >
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="formulario_pacientes.php">Pesquisar</a></li>
      ...
      <div class="row">
        <div class="col s2 m12 offset-m1 center" >
          ...
          <div class="row center">
            ...
            <?php
              $sth = $pdo->prepare("SELECT * FROM tbl_paciente WHERE p_nome LIKE '%$pesquisar%'");
              $sth->execute();
              $resultado = $sth->fetch(PDO::FETCH_ASSOC);
              extract($resultado);
            ?>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td><h6><a href="../ver/ver.php?id=<?= $p_login; ?>"><?= substr($p_nome, 0, 38); ?></a></h6></td>
