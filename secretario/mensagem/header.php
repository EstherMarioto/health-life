        ...
        <div class="nav-item dropdown">
          <ul class="navbar-nav mr-auto">
            ...
            <div class="dropdown-menu " aria-labelledby="navbarDropdown">
              <a class="dropdown-item " href="mensagem_enfermeiro.php">Contato Enfermeiro</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="mensagem_medico.php">Contato Médico</a>
              <div class="dropdown-divider"></div>
              <?php if($un_dtl_unidade == 2 ){ ?>
                <a class="dropdown-item" href="mensagem_pac.php">Contato Paciente</a>
                <?php }else{ ?>
                <a class="dropdown-item" href="mensagem_paciente.php">Consultas Paciente</a>
                <?php }; ?>
