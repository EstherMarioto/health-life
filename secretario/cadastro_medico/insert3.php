...
$sth = $pdo -> prepare("INSERT INTO tbl_img_dado (im_dado,im_medico,im_detalhe) VALUES (:me_comp_rg2, :me_codigo,:idd12)");
     
    $sth->bindValue(':me_comp_rg2', $me_comp_rg2);
    $sth->bindValue(':me_codigo', $me_codigo);
    $sth->bindValue(':idd12', $idd12);
    $sth->execute();

    header("Location:insert4.php?me_codigo=$me_codigo&&me_comp_residencia=$me_comp_residencia&&me_titulo_eleitor=$me_titulo_eleitor&&me_titulo_eleitor2=$me_titulo_eleitor2&&me_certidao_cas=$me_certidao_cas&&me_doc_pis=$me_doc_pis&&me_car_trab=$me_car_trab&&me_car_trab2=$me_car_trab2&&me_declaracao_bens=$me_declaracao_bens&&me_comp_esc=$me_comp_esc&&me_comp_esc2=$me_comp_esc2");  
